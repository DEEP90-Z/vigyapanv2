...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      <div 
        className={`mr-3 hidden sm:flex items-center rounded-full bg-luxury-black/90 border border-luxury-gold/30 px-4 py-2 text-xs font-semibold tracking-wide text-white shadow-xl backdrop-blur-md transition-all duration-300 ${
      ...
      <a
        ...
        className="relative group flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-tr from-[#128C7E] to-[#25D366] text-white shadow-[0_8px_25px_rgba(37,211,102,0.4)] transition-all duration-300 hover:scale-110 active:scale-95 hover:shadow-[0_12px_30px_rgba(37,211,102,0.6)] border border-white/20"
      >
        {/* Pulse effect ring */}
