  ...
  return (
    <section id="home" className="relative h-screen w-full flex items-end justify-end overflow-hidden bg-luxury-black">
      ...
      <div className="absolute inset-0 w-full h-full">
        <video 
          src="/videos/banner-video-6-2.mp4" 
          autoPlay 
          loop 
          muted 
          playsInline
      ...
      {/* Cinematic Overlays (Reduced for visibility) */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Subtle dark wash to ensure text readability without hiding the video */}
        ...
        {/* Bottom-right shadow specifically for the text */}
        <div className="absolute bottom-0 right-0 w-full md:w-2/3 h-2/3 bg-[radial-gradient(ellipse_at_bottom_right,rgba(0,0,0,0.6)_0%,transparent_70%)]" />
      </div>
      ...
      <div className="container-wide w-full px-8 md:px-16 pb-20 md:pb-24 relative z-10 flex flex-col items-end text-right">
        ...
        <motion.div
          ...
          style={{ willChange: "transform, opacity" }}
        >
          <button className="px-10 py-4 bg-transparent border border-white/30 text-white rounded-full hover:bg-white hover:text-luxury-black transition-all duration-500 uppercase tracking-[0.2em] text-xs font-bold hover:scale-105 active:scale-95 backdrop-blur-md">
            Explore Campaigns
          </button>
        </motion.div>
      </div>
